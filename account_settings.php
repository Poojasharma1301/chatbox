...
<div class="row">
  ...
  <div class="col-sm-8">
    <form action="" method="post" enctype="multipart/form-data">
          <table class="table table-bordered table-hover alert-secondary">
            <tr align="center">
              <td colspan="6" class="active text-info" ><h2>Change Account Settings</h2></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">Forgotten Password</button>
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <input class="btn btn-primary" type="submit" name="sub" value="Submit" style="width:100px;" /><br><br>
