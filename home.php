			...
			<div class="col-md-3 col-sm-3 col-xs-12 left-sidebar">
				<div class="input-group searchbox">
					<div class="input-group-btn">
						<center><a href="include/find_friends.php"><button class="btn btn-success search-icon" name="search_user" type="submit">Add new user</button></a></center>
					</div>
				</div>
				<div class="left-chat">
					<ul>
			...
			<div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
				...
				<div class="row">
					<div class="col-md-12 right-chat-textbox">
						...
						<button class="btn btn-primary" name="submit"><i class="fa fa-telegram" aria-hidden="true"></i></button>
						</form>
					</div>
				</div>
			</div>
